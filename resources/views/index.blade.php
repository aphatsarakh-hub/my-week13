    ...
    <style>
        ...
        .custom-navbar {
            ...
            box-shadow:
                ...
                0 1px 3px rgba(190, 24, 93, 0.015);
        ...
        .custom-navbar:hover {
            box-shadow:
                ...
                0 3px 10px rgba(236, 72, 153, 0.04);
        ...
        .btn-primary-custom {
            ...
            box-shadow:
                0 10px 25px -5px rgba(236, 72, 153, 0.35);
        }
        ...
        .btn-primary-custom:hover {
            ...
            box-shadow:
                0 15px 30px -5px rgba(236, 72, 153, 0.45);
        }
        ...
        .feature-card:hover {
            ...
            box-shadow:
                0 20px 40px -15px rgba(236, 72, 153, 0.18);
