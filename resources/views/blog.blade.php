...
@section('content')
            ...
            <form action="{{ url('/blog') }}" method="GET" style="width: 100%; max-width: 360px;">
                <div style="position: relative; width: 100%;">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        ...
                        onfocus="this.style.borderColor='var(--primary)'; this.style.borderStyle='solid'; this.style.boxShadow='0 0 0 4px rgba(236, 72, 153, 0.15)';"
    ...
    <style>
        ...
        .blog-card:hover {
            ...
            box-shadow: 0 20px 40px -15px rgba(236, 72, 153, 0.15) !important;
            cursor: pointer;
        }
